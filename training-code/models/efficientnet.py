...
from models.common import Conv2dNormActivation, SqueezeExcitation, _make_divisible, load_filtered_state_dict
...
class EfficientNet(nn.Module):
    def __init__(
        ...
        #original FC Layer for EfficientNet
...
def _efficientnet(
    ...
    weights: Optional[EfficientNet_B0_Weights],
    progress: bool,
    **kwargs: Any,
) -> EfficientNet:
